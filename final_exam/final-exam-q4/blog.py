...
def post_new_comment():
    ...
    if name == "" or body == "":
        ...
        # it all looks good, insert the comment
        # into the blog post and redirect back to the post viewer
...
# extracts the tag from the tags form element. an experience python programmer
# could do this in  fewer lines, no doubt
...
bottle.TEMPLATE_PATH.insert(0, '/home/code/M101PMongoDB/final_exam/final-exam-q4/views')
bottle.debug(True)
